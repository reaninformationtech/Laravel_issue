                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker form-control" name="stockcode"
                                                    id="stockcode" data-live-search="true">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form_data').on('submit', function(event) {
                ...
                var v_stockcode = $('#stockcode').val();
                var v_remark = $('#remark').val();
                v_remark = v_remark.replace(",", "/");


                if (v_stockcode.trim() == '' || v_stockcode.trim() == null) {
                ...
                if (status == '') {
                    var row = "I|" + v_stockcode + "|" + v_remark;
                    rows.push(row);
