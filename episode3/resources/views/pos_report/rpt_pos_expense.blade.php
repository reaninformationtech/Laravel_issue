        ...
        <div class="col-md-12">
            <form method="post" id="form_data" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    ...
                    <div id="table_data">
                        @include('pos_report/rpt_pos_income_data')
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="table_img">
                            @include('pos_report/rpt_pos_expense_img')
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("a").click(function(event) {
                ...
                var vstatus='';
                $('#tableToExcel tbody tr').each(function() {
                    vstatus = $(this).find('td').eq(0).text().trim();
                });
                console.log(vstatus);
            ...
            $('#form_data').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('pos_report.rpt_get_pos_expense') }}",
                    method: "POST",
                    async: false,
