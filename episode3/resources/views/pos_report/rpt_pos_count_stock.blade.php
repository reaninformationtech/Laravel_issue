        ...
        <div class="col-md-12">
            <form method="post" id="form_data" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <select class="selectpicker form-control" name="stockfrom" id="stockfrom"
                    ...
                    <div id="table_data">
                        @include('pos_report/rpt_pos_count_stock_data')
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form_data').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('pos_report.rpt_get_pos_count_stock') }}",
                    method: "POST",
                    async: false,
