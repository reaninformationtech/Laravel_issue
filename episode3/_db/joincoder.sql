...
--
-- Host: localhost:3306
-- Generation Time: Aug 16, 2021 at 08:46 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pos_rpt_get_count_stock` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_stockcode` VARCHAR(20), IN `v_product` VARCHAR(200), IN `v_date_from` DATE, IN `v_date_to` DATE, IN `v_inputer` VARCHAR(200))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pos_rpt_get_income` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_line` VARCHAR(50), IN `v_currency` VARCHAR(50), IN `v_date_from` DATE, IN `v_date_to` DATE, IN `v_inputer` VARCHAR(200))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pos_rpt_get_product_in_stock` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_stock` VARCHAR(20), IN `v_product` VARCHAR(200), IN `v_type` VARCHAR(50), IN `v_line` VARCHAR(50), IN `v_date_to` DATE, IN `v_inputer` VARCHAR(200))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pos_rpt_get_purchase` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_stock` VARCHAR(20), IN `v_product` VARCHAR(200), IN `v_type` VARCHAR(50), IN `v_line` VARCHAR(50), IN `v_date_from` DATE, IN `v_date_to` DATE, IN `v_inputer` VARCHAR(200))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pos_rpt_get_sold_out` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_product` VARCHAR(200), IN `v_type` VARCHAR(50), IN `v_line` VARCHAR(50), IN `v_date_from` DATE, IN `v_date_to` DATE, IN `v_inputer` VARCHAR(200))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pos_rpt_get_stock_transfer` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_stockfrom` VARCHAR(20), IN `v_stockto` VARCHAR(20), IN `v_product` VARCHAR(200), IN `v_date_from` DATE, IN `v_date_to` DATE, IN `v_inputer` VARCHAR(200))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_main_menu` (IN `v_status` VARCHAR(25), IN `v_menuid` VARCHAR(255), IN `v_menu_name` VARCHAR(255), IN `v_inactive` VARCHAR(255), IN `v_inputer` VARCHAR(255), IN `v_icon1` VARCHAR(255), IN `v_icon2` VARCHAR(255), IN `v_icon3` VARCHAR(255), IN `v_class1` VARCHAR(255), IN `v_class2` VARCHAR(255), IN `v_class3` VARCHAR(255))  BEGIN
  ...
  IF (v_status = 'i') THEN
	CALL GB_MODIFY_NEXT_ID('main_menu', '1', vsubm_id);
		...
		INSERT INTO tbl_main_left_menu (menu_id, menu_name, menu_effective_date, menu_inactive, menu_inputer, menu_glyphicon1, menu_glyphicon2, menu_glyphicon3, menu_class1, menu_class2, menu_class3)
		  VALUES (vsubm_id, v_menu_name, SYSDATE(), v_inactive, v_inputer, v_icon1, v_icon2, v_icon3, v_class1, v_class2, v_class3);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_permission_by_branch` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_profile_id` VARCHAR(25), IN `v_menu_id` VARCHAR(25), IN `v_view` TINYINT, IN `v_booking` TINYINT, IN `v_edit` TINYINT, IN `v_delete` TINYINT, IN `v_token` VARCHAR(50), IN `v_inputer` VARCHAR(50))  BEGIN
  ...
  IF (v_status = 'I' ) THEN
	...
	CALL gb_next_id_branch(v_branchcode,'permission_branch', '1', vsubm_id);
	 ...
	 INSERT INTO tbl_menu_permission_branch (per_id,menu_id,profile_id ,branchcode ,views,booking,edit,deletes,keytoken,inputer,inputdate) 
			VALUES (vsubm_id,v_menu_id,v_profile_id,v_branchcode,v_view,v_booking,v_edit,v_delete,v_token,v_inputer,SYSDATE());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_permission_gb` (IN `v_status` VARCHAR(25), IN `v_menu_id` VARCHAR(25), IN `v_systemid` VARCHAR(25), IN `v_pro_id` VARCHAR(25), IN `v_token` VARCHAR(50), IN `v_inputer` VARCHAR(50), IN `v_view` TINYINT, IN `v_booking` TINYINT, IN `v_edit` TINYINT, IN `v_delete` TINYINT)  BEGIN
  ...
  IF (v_status = 'I' ) THEN
	...
	CALL GB_MODIFY_NEXT_ID('gb_permission', '1', vsubm_id);
	 ...
	 INSERT INTO gb_tbl_permission (per_id,menu_id,systemid,pro_id,views,booking,edit,deletes,keytoken,inputer,inputdate) VALUES (vsubm_id,v_menu_id,v_systemid,v_pro_id,v_view,v_booking,v_edit,v_delete,v_token,v_inputer,SYSDATE());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_permssion` (IN `v_status` VARCHAR(25), IN `v_system` VARCHAR(25), IN `v_menu_id` VARCHAR(25), IN `v_view` TINYINT, IN `v_booking` TINYINT, IN `v_edit` TINYINT, IN `v_delete` TINYINT, IN `v_token` VARCHAR(50), IN `v_inputer` VARCHAR(50))  BEGIN
  ...
  IF (v_status = 'I' ) THEN
	...
	CALL GB_MODIFY_NEXT_ID('permission_menu', '1', vsubm_id);
	 ...
	 INSERT INTO tbl_menu_permission (per_id,systemid,menu_id,views,booking,edit,deletes,keytoken,inputer,inputdate) VALUES (vsubm_id,v_system,v_menu_id,v_view,v_booking,v_edit,v_delete,v_token,v_inputer,SYSDATE());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_profile` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(255), IN `v_profileid` VARCHAR(255), IN `v_profilename` VARCHAR(255), IN `v_inactive` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
	
	SELECT v_status;
	
  IF (v_status = 'admin') THEN
	 
  	  INSERT INTO gb_profile_by_branch (profileid,branchcode,profilename,inactive,trandate,inputer) VALUES (v_profileid,v_branchcode,v_profilename,v_inactive,NOW(),v_inputer);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_system_controls` (IN `v_status` VARCHAR(25), IN `v_sys_con_id` VARCHAR(255), IN `v_sys_con_name` VARCHAR(255), IN `v_sys_con_short_name` VARCHAR(255), IN `v_sys_con_effective` DATE, IN `v_sys_con_inactive` VARCHAR(255), IN `v_sys_con_remark` VARCHAR(255), IN `v_sys_con_inputer` VARCHAR(255))  BEGIN
  ...
  IF (v_status = 'I') THEN
	...
	INSERT INTO gb_system_controls (sys_con_id, sys_con_name, sys_con_inactive, sys_con_short_name, sys_con_effective, sys_con_remark, inputdate , inputer)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_system_profile` (IN `v_status` VARCHAR(25), IN `v_pro_id` VARCHAR(255), IN `v_branchcode` VARCHAR(255), IN `v_pro_name` VARCHAR(255) CHARSET utf8, IN `v_inactive` VARCHAR(25), IN `v_inputer` VARCHAR(255))  BEGIN
  	...
  	IF (v_status = 'I') THEN
		...
		INSERT INTO gb_profile_by_branch (profileid,branchcode,profilename,inactive,trandate,inputer) VALUES (vprofile_id,v_branchcode,v_pro_name,v_inactive,NOW(),v_inputer);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_add_userinfo` (IN `v_status` VARCHAR(25), IN `v_userid` VARCHAR(25), IN `v_countrycode` VARCHAR(25), IN `v_full_name` VARCHAR(250), IN `v_contact` VARCHAR(250), IN `v_gender` VARCHAR(25), IN `v_bio` VARCHAR(255), IN `v_image_name` VARCHAR(255), IN `v_inputer` VARCHAR(255))  begin
 ...
 DECLARE v_subofbranch varchar(50);
  ...
  IF (v_status = 'I') THEN
	  	...
	  	IF (v_referent = 'admin') THEN
	  		-- CALL gb_next_id_branch(v_branchcode,'profile_id', '1', vprofile_id);
	  		-- CALL proc_add_profile('admin',v_branchcode,vprofile_id,'Supper admin','0','IT.SYSTEM');
	  		-- SET v_userid=v_user_id;
	  		-- CALL proc_auto_menu_permission ('auto',v_branchcode,vprofile_id,v_system);
	 	...
	 	INSERT  INTO gb_sys_users (id,email,password,salt,name,contact,conpassword,supper,branchcode,subofbranch,systemid,Inactive,profile,inputer,trandate)
	 			VALUES (v_userid,v_login_name,v_password,v_pwd_salt,v_user_name,v_contact,v_password,v_supper,v_branchcode,v_vsubofbranch,v_system,v_inactive,vprofile_id,v_inputer,NOW());
  ELSEIF (v_status = 'U') THEN
...
ELSEIF v_status = 'inactive' THEN
	  SELECT CONVERT('0' , CHAR CHARACTER SET utf8)  as id ,CONVERT('No' , CHAR CHARACTER SET utf8)  as name  FROM dual
	  union
	  SELECT CONVERT('1' , CHAR CHARACTER SET utf8)  as id ,CONVERT('Yes' , CHAR CHARACTER SET utf8)  as name  FROM dual;
	...
	IF v_status = 'branch' THEN
		...
		ELSE
			SELECT b.branchcode,
				   ...
				   b.country
			FROM gb_sys_branch b 
			WHERE b.branchcode LIKE CONCAT(v_branchcode, '%') or b.subofbranch LIKE CONCAT(v_branchcode, '%');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_kqr_add_sub_menu` (IN `v_status` VARCHAR(25), IN `v_id` VARCHAR(25), IN `v_menuid` VARCHAR(255), IN `v_name` VARCHAR(255), IN `v_function` VARCHAR(255), IN `v_inactive` VARCHAR(255), IN `v_inputer` VARCHAR(255), IN `v_icon` VARCHAR(255), IN `v_effect_date` DATE)  BEGIN
  ...
  DECLARE vsubm_id varchar(50);
	...
	INSERT INTO tbl_sub_left_menu (subm_id, menu_id, subm_name, subm_function, subm_inactive, subm_inputer, subm_glyphicon, subm_effective_date)
  	VALUES (vsubm_id, v_menuid, v_name, v_function, v_inactive, v_inputer, v_icon, v_effect_date);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_land_add_expend` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_exp_type` VARCHAR(25), IN `v_referent` VARCHAR(25), IN `v_exp_currency` VARCHAR(25), IN `v_unitprice` DECIMAL(13,4), IN `v_remark` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
  	...
  	IF (v_status = 'I') THEN
	    ...
	    INSERT INTO kqr_land_expend (exp_id,branchcode,exp_type,exp_referent,exp_currency,exp_unitprice,exp_remark,exp_inputer,exp_date) 
	                         VALUES (vsubm_id,v_branchcode,v_exp_type,v_referent,v_exp_currency,v_unitprice,v_remark,v_inputer,NOW());
	  
 	END IF ;
 
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_land_add_items` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(255), IN `v_branchcode` VARCHAR(25), IN `v_item_name` VARCHAR(255), IN `v_item_type` VARCHAR(25), IN `v_inactive` VARCHAR(2), IN `v_remark` VARCHAR(255), IN `v_location` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
  ...
  IF (v_status = 'I') THEN
	...
	CALL gb_next_id_branch(v_branchcode,'items_code', '1', vsubm_id);
		...
		INSERT INTO kqr_land_items (item_id, branchcode, item_name, item_type, item_inactive, item_remark, item_inputer, item_date,item_location,c_method)
		  VALUES (vsubm_id, v_branchcode, v_item_name, v_type, v_inactive, v_remark, v_inputer, NOW(),v_location,v_method);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_land_register` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_currency` VARCHAR(5), IN `v_name` VARCHAR(255) CHARSET utf8, IN `v_plan` VARCHAR(50), IN `v_type` VARCHAR(50), IN `v_size` VARCHAR(50), IN `v_street` VARCHAR(50), IN `v_inactive` INT, IN `v_views` INT, IN `v_cost` DECIMAL(13,4), IN `v_up` DECIMAL(13,4), IN `v_remark` VARCHAR(250) CHARSET utf8, IN `v_inputer` VARCHAR(50))  BEGIN
  DECLARE vsubm_id varchar(50);
   ...
   IF (v_status = 'i') THEN
		...
		INSERT INTO kqr_land_register_items (rg_id, branchcode, rg_name, currency, inactive, p_view, plan_id, type_id, size_id, street_id, cost, unitprice, remark, inputer, trandate)
		  VALUES (vsubm_id, v_branchcode, v_name, v_currency, v_inactive, v_views, v_plan, v_type, v_size, v_street, v_cost, v_up, v_remark, v_inputer, NOW());
	ELSEIF (v_status = 'u') THEN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_land_sale` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(255), IN `v_cus_id` VARCHAR(255), IN `v_item_id` VARCHAR(255), IN `v_up` DECIMAL(13,2), IN `v_discount` DECIMAL(13,2), IN `v_amount` DECIMAL(13,2), IN `v_remark` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
  ...
  IF (v_status = 'i') THEN
		...
		INSERT INTO kqr_land_sale (sal_id, rg_id, cus_id, branchcode, rg_name, cost, unitprice, discount, amount,sys_amount, inputer, trandate)
		  VALUES (vsubm_id, v_item_id, v_cus_id, v_branchcode, v_rg_name, v_cost, v_up, v_discount, v_amount,v_sys_amount, v_inputer, NOW());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_post_add_quote` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(10), IN `v_branchcode` VARCHAR(10), IN `v_type` VARCHAR(20), IN `v_quote` TEXT, IN `v_inputer` VARCHAR(255))  begin
	
	  DECLARE vsubm_id varchar(50);
	  if (v_status = 'I') then
	  	CALL gb_next_id_branch(v_branchcode,'quote_code', '1', vsubm_id);
	  	
	  	insert into post_tbl_quotes (id,branchcode,line ,quote,inputer,inputdate) values (vsubm_id,v_branchcode,v_type,v_quote,v_inputer,now());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_post_get_sql` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_condition1` VARCHAR(25), IN `v_condition2` VARCHAR(25))  begin
	...
	END IF ;
 	 ...
 	 elseif v_status = 'quote_list' then
 	 	...
 	 	where a.branchcode LIKE CONCAT(v_branchcode, '%') and a.id LIKE CONCAT(v_condition1, '%')
 	 	order by a.line ,a.id,a.inputdate ;
 	 end if ;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_count_stock` (IN `v_status` VARCHAR(20), IN `v_code` VARCHAR(20), IN `v_branchcode` VARCHAR(20), IN `v_stock` VARCHAR(20), IN `v_pro_code` VARCHAR(20), IN `v_qty` VARCHAR(20), IN `v_remark` VARCHAR(20), IN `v_token` VARCHAR(200), IN `v_inputer` VARCHAR(50))  BEGIN
	...
	IF (v_status='I')THEN 
		...
		IF (vexsisting='')THEN
			...
			INSERT INTO pos_tbl_una_count_stock(tran_code ,branchcode,stockcode,remark ,inputer,inputdate,sys_token)
				        values (p_tran_code,v_branchcode,v_stock,v_remark,v_inputer,now(),v_token);
		END IF;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_customer` (IN `v_status` VARCHAR(20), IN `v_branchcode` VARCHAR(20), IN `v_code` VARCHAR(20), IN `v_name` VARCHAR(50), IN `v_gender` VARCHAR(20), IN `v_phone` VARCHAR(20), IN `v_inactive` VARCHAR(20), IN `v_address` VARCHAR(200), IN `v_inputer` VARCHAR(50))  BEGIN
	...
	IF (v_status='I')THEN 
		...
		INSERT INTO pos_tbl_customers (cus_id,branchcode ,cus_name,cus_gender,cus_phone,inactive,cus_address,inputer,inputdate) 
								  VALUES (p_customerid,v_branchcode,v_name,v_gender,v_phone,v_inactive,v_address,v_inputer,NOW());
	...
	ELSEIF v_status = 'auto' THEN
			...
			INSERT INTO pos_tbl_customers (cus_id,branchcode ,cus_name,cus_gender,cus_phone,inactive,cus_address,inputer,inputdate) 
								  VALUES (v_code,v_branchcode,v_name,v_gender,v_phone,v_inactive,v_address,v_inputer,NOW());
	
	END IF;
	
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_expense` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(255), IN `v_branchcode` VARCHAR(25), IN `v_line_id` VARCHAR(255), IN `v_referent` VARCHAR(250), IN `v_currency` VARCHAR(250), IN `v_amount` VARCHAR(25), IN `v_remark` VARCHAR(255), IN `v_inputer` VARCHAR(50))  BEGIN
	...
	IF (v_status = 'expense') THEN
		...
		INSERT INTO pos_tbl_una_expense (tran_code ,branchcode,lin_id,currency ,amount,referent,remark,inputer,inputdate) VALUES (vsubm_id,v_branchcode,v_line_id,v_currency,v_amount,v_referent,v_remark,v_inputer,NOW());
	ELSEIF (v_status = 'income') THEN
		...
		INSERT INTO pos_tbl_una_income (tran_code ,branchcode,lin_id,currency ,amount,referent,remark,inputer,inputdate) 
					VALUES (vsubm_id,v_branchcode,v_line_id,v_currency,v_amount,v_referent,v_remark,v_inputer,NOW());
	END IF;

	SELECT v_code AS trancode;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_file` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_file_path` VARCHAR(250), IN `v_file_name` VARCHAR(250), IN `v_org_name` VARCHAR(255), IN `v_file_ext` VARCHAR(250), IN `v_line_type` VARCHAR(20), IN `v_inputer` VARCHAR(255))  BEGIN
	...
	IF (v_status = 'I') THEN
		...
		INSERT INTO pos_tbl_una_document_file(sysdonum,trancode,branchcode,file_path,file_name,org_name,file_ext,status,inputer,inputdate) 
				VALUES (vsubm_id,v_code,v_branchcode,v_file_path,v_file_name,v_org_name,v_file_ext,v_line_type,v_inputer,NOW());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_invoices` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_customerid` VARCHAR(20), IN `v_cus_name` VARCHAR(200), IN `v_cus_phone` VARCHAR(50), IN `v_cus_address` VARCHAR(50), IN `v_delivery` DECIMAL(13,4), IN `v_procode` VARCHAR(20), IN `v_stockcode` VARCHAR(20), IN `v_up` DECIMAL(13,4), IN `v_qty` DECIMAL(13,4), IN `v_discount` DECIMAL(13,4), IN `v_amount` DECIMAL(13,4), IN `v_token` VARCHAR(200), IN `v_inputer` VARCHAR(200))  BEGIN
	...
	IF (v_customerid='' or v_customerid is null )THEN
		...
		CALL proc_pos_add_customer ('auto',v_branchcode,v_cus_id,v_cus_name,'01',v_cus_phone,'0',v_cus_address,v_inputer);
	...
	IF (v_status = 'I') THEN
		...
		IF (vexsisting='')THEN
			...
			INSERT INTO pos_tbl_una_invoices (inv_num,cus_id,branchcode,inv_date,inv_exchange,inputer,inputdate,sys_token) 
						values (v_invoice,v_cus_id,v_branchcode,now(),'4100',v_inputer,NOW(),v_token);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_line` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(255), IN `v_branchcode` VARCHAR(25), IN `v_line_type` VARCHAR(10), IN `v_line_name` VARCHAR(250), IN `v_inactive` VARCHAR(2), IN `v_remark` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
	...
	IF (v_status = 'I') THEN
		...
		INSERT INTO pos_tbl_proline (line_id,branchcode,line_name,line_type,inactive,line_remark,inputer,inputdate) VALUES (vsubm_id,v_branchcode,v_line_name,v_line_type,v_inactive,v_remark,v_inputer,NOW());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_product` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_barcode` VARCHAR(20), IN `v_type` VARCHAR(20), IN `v_line` VARCHAR(20), IN `v_name` VARCHAR(250), IN `v_cost` DECIMAL(13,4), IN `v_up` DECIMAL(13,4), IN `v_discount` DECIMAL(13,4), IN `v_inactive` VARCHAR(10), IN `v_remark` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
	...
	INSERT INTO pos_tbl_products (pro_id,branchcode,barcode,pro_type,pro_line,pro_name,pro_cost,pro_up,pro_discount,pro_inactive,remark,inputer,inputdate)
		        VALUES (vsubm_id,v_branchcode,v_barcode,v_type,v_line,v_name,v_cost,v_up,v_discount,v_inactive,v_remark,v_inputer,NOW());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_purchaseorder` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_supply` VARCHAR(20), IN `v_invoice` VARCHAR(200), IN `v_remark` VARCHAR(20), IN `v_procode` VARCHAR(20), IN `v_stockcode` VARCHAR(20), IN `v_cost` DECIMAL(13,4), IN `v_qty` DECIMAL(13,4), IN `v_discount` DECIMAL(13,4), IN `v_amount` DECIMAL(13,4), IN `v_pro_remark` VARCHAR(200), IN `v_token` VARCHAR(200), IN `v_inputer` VARCHAR(200))  BEGIN
	...
	IF (v_status = 'I') THEN
		...
		IF (vexsisting='')THEN
			...
			INSERT INTO pos_tbl_una_purchase_order (pur_id,branchcode,sup_id,pur_invoice,remark,inputer,inputdate,sys_token) 
						values (vpur_id,v_branchcode,v_supply,v_invoice,v_remark,v_inputer,NOW(),v_token);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_stock_transfer` (IN `v_status` VARCHAR(20), IN `v_code` VARCHAR(20), IN `v_branchcode` VARCHAR(20), IN `v_f_stock` VARCHAR(50), IN `v_t_stock` VARCHAR(20), IN `v_pro_code` VARCHAR(20), IN `v_qty` VARCHAR(20), IN `v_remark` VARCHAR(250), IN `v_token` VARCHAR(200), IN `v_inputer` VARCHAR(50))  BEGIN
	...
	IF (v_status='I')THEN 
		...
		IF (vexsisting='')THEN
			...
			INSERT INTO pos_tbl_una_stocktransfer(tran_code ,branchcode,f_stock,t_stock,remark ,inputer,inputdate,sys_token)
				        values (p_tran_code,v_branchcode,v_f_stock,v_t_stock,v_remark,v_inputer,now(),v_token);
		END IF;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_add_supplier` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_type` VARCHAR(20), IN `v_name` VARCHAR(250), IN `v_inactive` VARCHAR(2), IN `v_phone` VARCHAR(255), IN `v_email` VARCHAR(255), IN `v_websit` VARCHAR(255), IN `v_address` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
	...
	IF (v_status = 'I') THEN
		...
		INSERT INTO pos_tbl_supplier(sup_id,branchcode,sup_type,sup_name,sup_phone,sup_email,sup_address,sup_website,inactive,inputer,inputdate) 
			   VALUES (vsubm_id,v_branchcode,v_type,v_name,v_phone,v_email,v_address,v_websit,v_inactive,v_inputer,NOW());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_authorize` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
	
	IF v_status = 'auth_pos_purchase' THEN
		
		INSERT INTO pos_tbl_purchase_order (pur_id,branchcode,sup_id,pur_invoice,remark,inputer,inputdate,sys_token) 
		SELECT pur_id,branchcode,sup_id,pur_invoice,remark,inputer,inputdate,sys_token 
		...
		CALL proc_pos_purchase_post(v_status,v_branchcode,v_id,v_inputer);
	...
	ELSEIF v_status = 'auth_pos_invoice' THEN 
		...
		INSERT INTO pos_tbl_invoices (inv_num,cus_id,branchcode,inv_date,inv_exchange,inputer,inputdate,sys_token,authorizer,auth_date)
			   SELECT inv_num,cus_id,branchcode,inv_date,inv_exchange,inputer,inputdate,sys_token,v_inputer,NOW() 
		...
		CALL proc_pos_invoice_post(v_status,v_branchcode,v_id,v_inputer);
	...
	ELSEIF v_status = 'auth_stock_transfer' THEN 
		   ...
		   INSERT INTO pos_tbl_stocktransfer (tran_code,branchcode,f_stock,t_stock,remark,inputer,inputdate,authorizer,auth_date,sys_token)
		   			   SELECT tran_code ,branchcode,f_stock,t_stock,remark,inputer,inputdate,v_inputer,now(),sys_token 
		   ...
		   DELETE a FROM pos_tbl_una_stocktransfer_detail as a WHERE a.branchcode=v_branchcode and a.tran_code =v_id;
		  	...
		  	-- AutoPost transaction
		   CALL proc_pos_stock_transfer_post(v_status,v_branchcode,v_id,v_inputer);
		   
	ELSEIF v_status = 'auth_count_stock' THEN 
	
			INSERT INTO pos_tbl_count_stock (tran_code,branchcode,stockcode ,remark,inputer,inputdate,authorizer,auth_date,sys_token)
		   			   SELECT tran_code ,branchcode,stockcode,remark,inputer,inputdate,v_inputer,now(),sys_token 
		  	...
		  	-- AutoPost transaction
		   	CALL proc_pos_count_stock_post(v_status,v_branchcode,v_id,v_inputer);
	ELSEIF v_status = 'auth_return_stock' THEN 
		...
		INSERT INTO pos_tbl_invoice_return (inv_num,cus_id,branchcode,inv_date,inv_exchange,inv_referent ,inv_reason ,inputer,inputdate,sys_token,authorizer,auth_date)
			   SELECT inv_num,cus_id,branchcode,inv_date,inv_exchange,inv_referent ,inv_reason ,inputer,inputdate,sys_token,v_inputer,NOW() 
		...
		-- AutoPost transaction
		CALL proc_pos_return_invoice_post(v_status,v_branchcode,v_id,v_inputer);


	ELSEIF v_status = 'auth_expense' THEN 
		DELETE a FROM pos_tbl_expense as a WHERE a.branchcode=v_branchcode and a.tran_code=v_id;
	
		INSERT INTO pos_tbl_expense (tran_code,branchcode,lin_id,currency,amount,referent,remark,inputer,inputdate,authorizer,auth_date)
				    select tran_code,branchcode,lin_id,currency,amount,referent,remark,inputer,inputdate,v_inputer,NOW() 
				    FROM  pos_tbl_una_expense  as a 
				    WHERE a.branchcode=v_branchcode and a.tran_code = v_id;
		
		INSERT INTO pos_tbl_document_file(sysdonum,trancode,branchcode,file_path,file_name,org_name,file_ext,status,inputer,inputdate) 
				select DISTINCT a.sysdonum,a.trancode,a.branchcode,a.file_path,a.file_name,a.org_name,a.file_ext,a.status,a.inputer,a.inputdate
	...
	ELSEIF v_status = 'auth_income' THEN 
		...
		INSERT INTO pos_tbl_income (tran_code,branchcode,lin_id,currency,amount,referent,remark,inputer,inputdate,authorizer,auth_date)
				    select tran_code,branchcode,lin_id,currency,amount,referent,remark,inputer,inputdate,v_inputer,NOW() 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_auth_tiller` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(255), IN `v_branchcode` VARCHAR(25), IN `v_token` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_count_stock_post` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
    ...
    DECLARE c_date 		 DATE;
	  ...
	  OPEN cursor_i;
	   ...
	   IF done THEN
	    ...
	    CALL proc_pos_post_transaction ('cut_count_stock',v_branchcode,v_id,c_pro_code, c_barcode ,stockcode,c_total_qty,v_inputer);
	    CALL proc_pos_post_transaction ('count_stock',v_branchcode,v_id,c_pro_code, c_barcode ,stockcode,c_qty,v_inputer);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_get_sql` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_condition1` VARCHAR(25), IN `v_condition2` VARCHAR(25))  BEGIN
	 ...
	 ELSEIF v_status = 'limit_product' THEN
			...
			FROM pos_tbl_products as a 
			WHERE a.branchcode LIKE CONCAT(v_branchcode, '%') AND 
				 (a.pro_id LIKE CONCAT(v_condition1, '%') OR a.pro_name LIKE CONCAT('%',v_condition1,'%')) ORDER BY a.pro_id LIMIT 20;
	 ...
	 ELSEIF v_status = 'list_customer' THEN
	 		...
	 		INNER JOIN gb_sys_contant_fix f on a.cus_gender=f.con_value and f.con_name ='gender'
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_invoice_post` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
    ...
    DECLARE c_date 		 DATE;
	  ...
	  OPEN cursor_i;
	   ...
	   IF done THEN
	    ...
	    CALL proc_pos_post_transaction (v_status,v_branchcode,v_id,c_pro_code, c_barcode ,c_stockcode,c_qty,v_inputer);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_land_tiller` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_checked` VARCHAR(25), IN `v_referent` VARCHAR(50), IN `v_inputer` VARCHAR(55))  BEGIN
	...
	ELSEIF v_status = 'Auth_tiller' THEN
	 	...
	 	INSERT INTO tbl_land_tillers (tiller_num,branchcode,inputer,inputdate) values (v_referent,v_branchcode,v_inputer,NOW());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_post_transaction` (IN `v_status` VARCHAR(20), IN `v_branchcode` VARCHAR(20), IN `v_referent` VARCHAR(20), IN `v_procode` VARCHAR(20), IN `v_barcode` VARCHAR(20), IN `v_stockcode` VARCHAR(20), IN `v_qty` DECIMAL(13,4), IN `v_inputer` VARCHAR(50))  BEGIN
	...
	INSERT INTO pos_tbl_transactions (sysdocnum,branchcode,pro_code,pro_barcode,trancode,stockcode,trn_status,trn_ref,trn_qty,trn_qty_tt,inputer,inputdate)
				values (p_sysdocnum,v_branchcode,v_procode,v_barcode,p_trancode,v_stockcode,v_status,v_referent,p_qty,0,v_inputer,NOW());
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_purchase` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
    ...
    DECLARE c_date 		 DATE;
	  ...
	  OPEN cursor_i;
	   ...
	   IF done THEN
	    ...
	    CALL proc_pos_post_transaction ('purchaseorder',v_branchcode,v_id,c_pro_code, c_barcode ,c_stockcode,c_qty,v_inputer);
	    Call proc_pos_referesh_by_stock ('auto',v_branchcode,c_pro_code,c_stockcode,c_date);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_purchase_post` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_return_invoices` (IN `v_status` VARCHAR(25), IN `v_code` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_referent` VARCHAR(200), IN `v_remark` VARCHAR(50), IN `v_procode` VARCHAR(20), IN `v_stockcode` VARCHAR(20), IN `v_up` DECIMAL(13,4), IN `v_qty` DECIMAL(13,4), IN `v_discount` DECIMAL(13,4), IN `v_amount` DECIMAL(13,4), IN `v_token` VARCHAR(200), IN `v_inputer` VARCHAR(200))  BEGIN
	...
	IF (v_status = 'I') THEN
		...
		IF (vexsisting='')THEN
			...
			INSERT INTO pos_tbl_una_invoice_return (inv_num,cus_id,branchcode,inv_date,inv_exchange,inv_referent,inv_reason ,inputer,inputdate,sys_token) 
						values (v_invoice,v_cus_id,v_branchcode,now(),'4100',v_referent,v_remark,v_inputer,NOW(),v_token);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_return_invoice_post` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
    ...
    DECLARE c_date 		 DATE;
	  ...
	  OPEN cursor_i;
	   ...
	   IF done THEN
	    ...
	    CALL proc_pos_post_transaction ('return_invoice',v_branchcode,v_id,c_pro_code, c_barcode ,c_stockcode,c_qty,v_inputer);
	    Call proc_pos_referesh_by_stock ('auto',v_branchcode,c_pro_code,c_stockcode,c_date);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_stock_transfer_post` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
    ...
    DECLARE c_date 		 DATE;
	  ...
	  OPEN cursor_i;
	   ...
	   IF done THEN
	    ...
	    CALL proc_pos_post_transaction ('f_stocktransfer',v_branchcode,v_id,c_pro_code, c_barcode ,f_stockcode,c_qty,v_inputer);
	    CALL proc_pos_post_transaction ('t_stocktransfer',v_branchcode,v_id,c_pro_code, c_barcode ,t_stockcode,c_qty,v_inputer);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_pos_transaction` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_id` VARCHAR(20), IN `v_inputer` VARCHAR(50))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_register_branch` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(255), IN `v_system` VARCHAR(255), IN `v_branch_name` VARCHAR(255), IN `v_user_name` VARCHAR(255), IN `v_Hash_password` VARCHAR(255), IN `v_Password` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
	 DECLARE v_subofbranch varchar(50);
  	  DECLARE vsubm_id 		varchar(50);
		...
		INSERT INTO gb_sys_branch (branchcode,subofbranch,branchname,setname,inactive,trandate,inputer,country,phone,email,website,branchshort)
			   values (vsubofbranch,vsubofbranch,CONCAT(v_branch_name, '-','PO'),CONCAT(v_branch_name, '-','PO'),'0',NOW(),v_inputer,'855','','','',v_branch_name);
		
		INSERT INTO gb_sys_branch (branchcode,subofbranch,branchname,setname,inactive,trandate,inputer,country,phone,email,website,branchshort)
			   values (vbranchcode,vsubofbranch,v_branch_name,v_branch_name,'0',NOW(),v_inputer,'855','','','',v_branch_name);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_register_branch_full` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(255), IN `v_branch_name` VARCHAR(255), IN `v_full_name` VARCHAR(255), IN `v_shot_name` VARCHAR(255), IN `v_inactive` VARCHAR(255), IN `v_phone` VARCHAR(255), IN `v_email` VARCHAR(255), IN `v_website` VARCHAR(255), IN `v_inputer` VARCHAR(255))  BEGIN
	  ...
	  DECLARE v_subofbranch varchar(50);
		...
		INSERT INTO gb_sys_branch (branchcode,subofbranch,branchname,setname,inactive,trandate,inputer,country,phone,email,website,branchshort,v_branch_name)
			   values (vsubm_id,vsubm_id,v_branch_name,v_branch_name,'0',NOW(),v_inputer,'855','','','');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_reset_pwd_user` (IN `v_status` VARCHAR(25), IN `v_user_id` VARCHAR(255), IN `v_branchcode` VARCHAR(50), IN `v_password` VARCHAR(5000), IN `v_pwd_salt` VARCHAR(5000), IN `v_inputer` VARCHAR(255))  BEGIN
		
	 IF (v_status = 'Resetpwd') THEN
		 	
		 
		 	INSERT INTO His_gb_sys_users (user_id,branchcode,username,password,salt,inputer,trandate) 
		 				SELECT id ,branchcode,email,password ,salt,inputer,NOW() 
		 				FROM gb_sys_users as a 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `rpt_pos_monthly_closing` (IN `v_status` VARCHAR(25), IN `v_branchcode` VARCHAR(25), IN `v_currency` VARCHAR(50), IN `v_date_from` DATE, IN `v_date_to` DATE, IN `v_inputer` VARCHAR(200))  BEGIN
...
('0168', 'pos_countstock', '5', 'pos_countstock'),
('0168', 'pos_customer', '98', 'pos_customer'),
('0168', 'pos_expense', '150', 'pos_expense'),
('0168', 'pos_fee', '9', 'pos_fee'),
('0168', 'pos_file', '144', 'pos_file'),
('0168', 'pos_invoice', '118', 'pos_invoice'),
('0168', 'pos_invoice_sysdonum', '126', 'pos_invoice_sysdonum'),
('0168', 'pos_line', '35', 'pos_line'),
('0168', 'pos_product', '44', 'pos_product'),
('0168', 'pos_purchaseorder', '12', 'pos_purchaseorder'),
('0168', 'pos_purchase_sysdonum', '23', 'pos_purchase_sysdonum'),
('0168', 'pos_stocktransfer', '144', 'pos_stocktransfer'),
('0168', 'pos_supplier', '3', 'pos_supplier'),
('0168', 'pos_transaction', '356', 'pos_transaction'),
('0168', 'profile_id', '3', 'profile_id'),
('0168', 'quote_code', '4', 'quote_code'),
('0168', 'user_id', '4', 'user_id'),
('0170', 'user_id', '1', 'user_id'),
('0172', 'user_id', '1', 'user_id'),
('0174', 'user_id', '1', 'user_id'),
('0176', 'user_id', '1', 'user_id');
...
INSERT INTO `gb_profile_by_branch` (`profileid`, `branchcode`, `profilename`, `inactive`, `trandate`, `inputer`) VALUES
('0001-0000', '0001', 'User admin', 0, '2020-12-30 21:05:59', 'pos@gmail.com'),
('0004-0001', '0004', 'Supper admin', 0, '2021-03-29 16:11:34', 'IT.SYSTEM'),
('0004-0002', '0004', 'Stock User', 0, '2021-03-29 10:05:19', 'pos@gmail.com'),
('0168-0001', '0168', 'Supper admin', 0, '2021-03-29 09:48:30', 'pos.SYSTEM'),
('0168-0002', '0168', 'Stock User', 0, '2021-03-29 09:51:43', 'pos@gmail.com'),
('0168-0003', '0168', 'Sale User', 0, '2021-03-29 09:51:58', 'pos@gmail.com');
...
INSERT INTO `gb_system_controls` (`sys_con_id`, `sys_con_name`, `sys_con_inactive`, `sys_con_short_name`, `sys_con_effective`, `sys_con_remark`, `inputer`, `inputdate`) VALUES
...
('40', 'COFFEE SYSTEM', 1, 'COF', '2021-01-01 00:00:00', NULL, 'joincoder@gmail.com', '2020-12-12 21:59:41');
...
INSERT INTO `gb_sys_branch` (`branchcode`, `subofbranch`, `branchname`, `setname`, `branchshort`, `inactive`, `trandate`, `phone`, `email`, `website`, `address`, `inputer`, `country`) VALUES
('0001', '0002', 'Technozoon company', 'HMS', 'TOZ', 0, '2019-09-18 21:33:03', '010500313', 'joincoder@gmail.com', 'www.khmerqr.com', 'រាជធានីភ្នំពេញ / ខណ្ឌឫស្សីកែវ / សង្កាត់គីឡូម៉ែត្រលេខ៦/ក្រោលគោ ផ្លូវបេតុង ក្រុម ១៣', 'abc', '855'),
...
('0168', '0167', 'POS Store', 'TECHNOZOON', 'TEZ', 0, '2021-03-29 09:48:30', '010500313', 'pos@gmail.com', 'www.toanchet.com', '#313,ST2001,Phnom Penh', 'IT.SYSTEM', '855'),
('0173', '0173', 'POSSTORE-PO', 'POSSTORE-PO', 'POSSTORE', 0, '2021-08-16 14:04:59', '', '', '', NULL, 'IT.SYSTEM', '855'),
('0174', '0173', 'POSSTORE', 'POSSTORE', 'POSSTORE', 0, '2021-08-16 14:04:59', '', '', '', NULL, 'IT.SYSTEM', '855'),
('0175', '0175', 'landsell-PO', 'landsell-PO', 'landsell', 0, '2021-08-16 14:05:51', '', '', '', NULL, 'IT.SYSTEM', '855'),
('0176', '0175', 'landsell', 'landsell', 'landsell', 0, '2021-08-16 14:05:51', '', '', '', NULL, 'IT.SYSTEM', '855'),
('0171', '0171', 'land168-PO', 'land168-PO', 'land168', 0, '2021-08-12 15:33:18', '', '', '', '#313,ST2001,Phnom Penh', 'IT.SYSTEM', '855'),
('0172', '0171', 'land168', 'land168', 'land168', 0, '2021-08-12 15:33:18', '078500313', 'land@gmail.com', 'www.land168.com', '#313,ST2001,Phnom Penh', 'IT.SYSTEM', '855');
...
('permission_menu', '478', 'permission_menu'),
('main_menu', '16', 'main_menu'),
('branchcode', '176', 'branchcode'),
('gb_permission', '554', 'gb_permission');
...
CREATE TABLE `gb_sys_users` (
  ...
  `inputer` varchar(50) COLLATE latin1_general_ci DEFAULT NULL,
  `trandate` datetime DEFAULT NULL
...
INSERT INTO `gb_sys_users` (`id`, `email`, `password`, `Inactive`, `salt`, `name`, `contact`, `conpassword`, `supper`, `branchcode`, `subofbranch`, `systemid`, `profile`, `lastworking`, `inputer`, `trandate`) VALUES
('0001', 'joincoder@gmail.com', '$2y$10$xSql04QTdfwIaK9dsThtAea64GYzPBXvwZjBBN8mNOjQhKSrdlAkK', 0, '$2y$10$76mmMhsK5I.SZd2CagslrubNm7qhyLD7.sWfkVJgQ/PX744obo56.', 'Admin Control', '010500313', 'db53f9a363967497a35ea959a5ad23fe911d32814aa0ccaccac124ccd99d28e1', 1, '0001', '0002', '20', '0001', NULL, 'rrrr', NULL),
('0168-0001', 'pos@gmail.com', '$2y$10$xSql04QTdfwIaK9dsThtAea64GYzPBXvwZjBBN8mNOjQhKSrdlAkK', 0, '$2y$10$r3WqTSvZ9geqbUl4wmcozu05B0h.DxqnpKAm74xU8N5dsDz20bfU.', 'Admin POS', '010500313', '123456', 0, '0168', '0167', '30', 'P00001', NULL, 'IT.SYSTEM', '2021-03-29 09:48:30'),
('0176-0001', 'landsell@gmail.com', '$2y$10$7cHnffl3Yj9FDZ33ZEK.YeFSg1gPNSjrYWczKW9GjqE3k7TauzVRi', 0, '$2y$10$Kr4gCoIKDWsqxMNHNPWQJOYHR2VM54OF0HFRW/axusQvY5fZo19Ke', 'Admin Seller', '010500313', '$2y$10$7cHnffl3Yj9FDZ33ZEK.YeFSg1gPNSjrYWczKW9GjqE3k7TauzVRi', 0, '0176', '0175', '20', 'P00020', NULL, 'IT.SYSTEM', '2021-08-16 14:05:51'),
('0174-0001', 'posstore@gmail.com', '$2y$10$EUWWQt3kzrUB2EaX0xqV4.NTYe6ov4hiWWlpv/8Szx2rvCh.yREji', 0, '$2y$10$Ig4mU.fo4VsMTwcNTX9yZuxc5KldwpuliLUB6kZEwip4ikwZNi/y6', 'None', 'N/A', '$2y$10$EUWWQt3kzrUB2EaX0xqV4.NTYe6ov4hiWWlpv/8Szx2rvCh.yREji', 0, '0174', '0173', '30', 'P00001', NULL, 'IT.SYSTEM', '2021-08-16 14:04:59'),
('0172-0001', 'land@gmail.com', '$2y$10$xSql04QTdfwIaK9dsThtAea64GYzPBXvwZjBBN8mNOjQhKSrdlAkK', 0, '$2y$10$hNs9361jBmM5ZAK5ghEWvur0RhYOLsRtFGnuF3gGj/l6J8564sRgG', 'Admin Land', '078500313', '$2y$10$z4xeJBisVceYA83gDq6D7OS.13SI1ivBAFDkcvIbF2MXpPUP9q0Yi', 0, '0172', '0171', '20', 'P00020', NULL, 'IT.SYSTEM', '2021-08-12 15:33:18');
...
('0001', '01', '01', 'Supper Admin', '0001_kOdWC.png', '2021-08-06 03:58:55'),
('0168-0001', '01', '01', 'Developer Technozoon', '0168-0001_vqFnK.png', '2021-08-06 04:00:14'),
('0172-0001', '01', '01', 'Supper admin', '0172-0001_IpwAu.png', '2021-08-12 15:34:06'),
('0176-0001', '01', '01', 'Best seller', '0176-0001_1ekb1.png', '2021-08-16 14:08:08');
...
CREATE TABLE `gb_tbl_currency` (
  ...
  `inactive` int(11) DEFAULT NULL,
  `inputer` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `gb_tbl_currency` (`currencycode`, `currencyname`, `currencyshort`, `inactive`, `inputer`) VALUES
...
INSERT INTO `gb_tbl_permission` (`per_id`, `menu_id`, `systemid`, `pro_id`, `views`, `booking`, `edit`, `deletes`, `keytoken`, `inputer`, `inputdate`) VALUES
('0172', '0002', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0173', 'SUB0001', '30', 'P00005', 0, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0174', 'SUB0002', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0175', 'SUB0008', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0176', 'SUB0009', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0177', 'SUB0010', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0178', 'SUB0011', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0179', 'SUB0012', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0180', 'SUB0013', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0181', 'SUB0024', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0182', '0003', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0183', 'SUB0015', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0184', 'SUB0017', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0185', 'SUB0020', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0186', 'SUB0029', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0187', '0009', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0188', 'SUB0026', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:30'),
('0189', 'SUB0031', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0190', 'SUB0032', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0191', 'SUB0033', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0192', 'SUB0034', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0193', 'SUB0035', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0194', 'SUB0036', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0195', 'SUB0037', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0196', 'SUB0038', '30', 'P00005', 1, 0, 0, 0, '610ab296eef05', 'joincoder@gmail.com', '2021-08-04 15:30:31'),
('0350', '0014', '30', 'P00001', 1, 0, 0, 0, '6119df001247b', 'joincoder@gmail.com', '2021-08-16 10:44:00'),
('0351', 'SUB0041', '30', 'P00001', 1, 0, 0, 0, '6119df001247b', 'joincoder@gmail.com', '2021-08-16 10:44:00'),
('0388', '0003', '20', 'P00022', 0, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0389', 'SUB0015', '20', 'P00022', 0, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0390', 'SUB0017', '20', 'P00022', 0, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0391', 'SUB0020', '20', 'P00022', 0, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0392', 'SUB0029', '20', 'P00022', 1, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0393', '0004', '20', 'P00022', 1, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0394', 'SUB0016', '20', 'P00022', 1, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0395', 'SUB0018', '20', 'P00022', 1, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0396', 'SUB0019', '20', 'P00022', 1, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0397', '0005', '20', 'P00022', 0, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0398', 'SUB0005', '20', 'P00022', 0, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0399', 'SUB0006', '20', 'P00022', 0, 0, 0, 0, '6119df31aa93d', 'joincoder@gmail.com', '2021-08-16 10:44:49'),
('0400', '0003', '20', 'P00021', 0, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0401', 'SUB0015', '20', 'P00021', 0, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0402', 'SUB0017', '20', 'P00021', 0, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0403', 'SUB0020', '20', 'P00021', 0, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0404', 'SUB0029', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0405', '0004', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0406', 'SUB0016', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0407', 'SUB0018', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0408', 'SUB0019', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0409', '0005', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0410', 'SUB0005', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0411', 'SUB0006', '20', 'P00021', 1, 0, 0, 0, '6119df3520eed', 'joincoder@gmail.com', '2021-08-16 10:44:53'),
('0412', '0003', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0413', 'SUB0015', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0414', 'SUB0017', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0415', 'SUB0020', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0416', 'SUB0029', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0417', '0004', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0418', 'SUB0016', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0419', 'SUB0018', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0420', 'SUB0019', '20', 'P00023', 0, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0421', '0005', '20', 'P00023', 1, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0422', 'SUB0005', '20', 'P00023', 1, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0423', 'SUB0006', '20', 'P00023', 1, 0, 0, 0, '6119df3fe3313', 'joincoder@gmail.com', '2021-08-16 10:45:03'),
('0454', '0002', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0455', 'SUB0001', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0456', 'SUB0002', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0457', 'SUB0008', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0458', 'SUB0009', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0459', 'SUB0010', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0460', 'SUB0011', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0461', 'SUB0012', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0462', 'SUB0013', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0463', 'SUB0024', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0464', '0003', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0465', 'SUB0015', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0466', 'SUB0017', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0467', 'SUB0020', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0468', 'SUB0029', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0469', '0009', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0470', 'SUB0026', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0471', 'SUB0031', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0472', 'SUB0032', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0473', 'SUB0033', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0474', 'SUB0034', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0475', 'SUB0035', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0476', 'SUB0036', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0477', 'SUB0037', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0478', 'SUB0038', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0479', '0012', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0480', 'SUB0027', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0481', 'SUB0028', '30', 'P00002', 0, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0482', '0014', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0483', 'SUB0041', '30', 'P00002', 1, 0, 0, 0, '6119df505f4b9', 'joincoder@gmail.com', '2021-08-16 10:45:20'),
('0484', '0002', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0485', 'SUB0001', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0486', 'SUB0002', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0487', 'SUB0008', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0488', 'SUB0009', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0489', 'SUB0010', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0490', 'SUB0011', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0491', 'SUB0012', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0492', 'SUB0013', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0493', 'SUB0024', '30', 'P00003', 1, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0494', '0003', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0495', 'SUB0015', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0496', 'SUB0017', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0497', 'SUB0020', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0498', 'SUB0029', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0499', '0009', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0500', 'SUB0026', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0501', 'SUB0031', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0502', 'SUB0032', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0503', 'SUB0033', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0504', 'SUB0034', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0505', 'SUB0035', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0506', 'SUB0036', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0507', 'SUB0037', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0508', 'SUB0038', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0509', '0012', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0510', 'SUB0027', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0511', 'SUB0028', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0512', '0014', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0513', 'SUB0041', '30', 'P00003', 0, 0, 0, 0, '6119df696836b', 'joincoder@gmail.com', '2021-08-16 10:45:45'),
('0514', '0003', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0515', 'SUB0015', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0516', 'SUB0017', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0517', 'SUB0020', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0518', 'SUB0023', '20', 'P00020', 0, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0519', 'SUB0029', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0520', '0004', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0521', 'SUB0016', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0522', 'SUB0018', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0523', 'SUB0019', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0524', '0005', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0525', 'SUB0005', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0526', 'SUB0006', '20', 'P00020', 1, 0, 0, 0, '6119e11628dff', 'joincoder@gmail.com', '2021-08-16 10:52:54'),
('0527', '0002', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0528', 'SUB0001', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0529', 'SUB0002', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0530', 'SUB0008', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0531', 'SUB0009', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0532', 'SUB0010', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0533', 'SUB0011', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0534', 'SUB0012', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0535', 'SUB0013', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0536', 'SUB0024', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0537', '0003', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0538', 'SUB0015', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0539', 'SUB0017', '30', 'P00001', 0, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0540', 'SUB0020', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0541', 'SUB0029', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0542', '0009', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0543', 'SUB0026', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0544', 'SUB0031', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0545', 'SUB0032', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0546', 'SUB0033', '30', 'P00001', 1, 1, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0547', 'SUB0034', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0548', 'SUB0035', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0549', 'SUB0036', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0550', 'SUB0037', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0551', 'SUB0038', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0552', '0012', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0553', 'SUB0027', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14'),
('0554', 'SUB0028', '30', 'P00001', 1, 0, 0, 0, '6119e12ad6513', 'joincoder@gmail.com', '2021-08-16 10:53:14');
...
INSERT INTO `gb_tbl_profile` (`pro_id`, `pro_name`, `inactive`, `systemid`, `trandate`, `inputer`) VALUES
...
INSERT INTO `his_gb_sys_users` (`user_id`, `branchcode`, `username`, `password`, `salt`, `inputer`, `trandate`) VALUES
...
('0001', '0001', 'joincoder@gmail.com', '$2y$10$3bM97XJ4jU42iRo.5sMq9OIRnQCJnaMo6SNJCyGmxiZEhOACJ/3fy', '$2y$10$3bM97XJ4jU42iRo.5sMq9OIRnQCJnaMo6SNJCyGmxiZEhOACJ/3fy', 'rrrr', '2021-08-06 08:23:00'),
('0001', '0001', 'joincoder@gmail.com', '$2y$10$Ax04Hdu1wppIWsk2neSTWevLE/7RoE2OujmnG12nDQUHyoueynxTK', '$2y$10$mcz3jDg0W/YPo/IK3QBvsuzhTslNOWRQsfXMGmaP4/oGb7Ce5VKfK', 'rrrr', '2021-08-06 08:23:03'),
('0001', '0001', 'joincoder@gmail.com', '$2y$10$sOv90iucppy5VV6SAoRzs.h3gHqF4.2e5uDWuHtPKU2Fx9MFksOG2', '$2y$10$x5AQQjzCpC5z9e81ur39Z.BDsVbDzXtxZT5SKxAPsTEI4SkEKLfvy', 'rrrr', '2021-08-16 10:20:09');
...
CREATE TABLE `kqr_land_customers` (
  ...
  `cus_inputer` varchar(255) DEFAULT '''NULL''',
...
CREATE TABLE `kqr_land_expend` (
  ...
  `exp_inputer` varchar(255) DEFAULT '''''''NULL''''''',
...
CREATE TABLE `kqr_land_items` (
  ...
  `item_inputer` varchar(255) COLLATE latin1_general_ci DEFAULT '''NULL''',
...
INSERT INTO `kqr_sys_address` (`id`, `khm_name`, `eng_name`, `inactive`, `inputer`, `trandate`) VALUES
...
--
-- Table structure for table `loan_tbl_clients`
--

CREATE TABLE `loan_tbl_clients` (
...
--
-- Table structure for table `loan_tbl_groups`
--

CREATE TABLE `loan_tbl_groups` (
  `groupid` varchar(20) NOT NULL,
  `customerid` varchar(20) NOT NULL,
  `disburse` datetime DEFAULT NULL,
  `first_paydate` datetime DEFAULT NULL,
  `loanterm` varchar(20) DEFAULT NULL,
  `Installment` float DEFAULT NULL,
  `InstallmentType` varchar(45) DEFAULT NULL,
  ...
  `ScheduleType` varchar(20) DEFAULT NULL,
  `inputer` varchar(50) DEFAULT NULL,
  `trandate` datetime DEFAULT NULL,
...
INSERT INTO `post_tbl_quotes` (`id`, `branchcode`, `line`, `quote`, `inputer`, `inputdate`) VALUES
...
INSERT INTO `pos_tbl_count_stock` (`tran_code`, `branchcode`, `stockcode`, `remark`, `inputer`, `inputdate`, `authorizer`, `auth_date`, `sys_token`) VALUES
...
('0007', '0001', '0001-0001', 'sell home', 'joincoder@gmail.com', '2021-03-27 17:04:19', 'joincoder@gmail.com', '2021-03-27 22:21:27', '0001-605f032380652'),
...
('0016', '0001', '0001-0001', NULL, 'joincoder@gmail.com', '2021-03-27 22:22:17', 'joincoder@gmail.com', '2021-03-27 22:22:21', '0001-605f4da92ad49'),
...
('0019', '0001', '0001-0001', '33333', 'joincoder@gmail.com', '2021-03-28 08:11:40', 'joincoder@gmail.com', '2021-03-28 08:11:49', '0001-605fd7ccc7c17'),
...
('0022', '0001', '0001-0001', 'Remark sale', 'joincoder@gmail.com', '2021-03-28 12:26:01', 'joincoder@gmail.com', '2021-03-28 12:26:09', '0001-6060136985b92'),
...
('0026', '0001', '0001-0001', 'Remark sale', 'joincoder@gmail.com', '2021-03-28 21:23:26', 'joincoder@gmail.com', '2021-03-28 22:30:30', '0001-6060915e93948'),
...
--
-- Dumping data for table `pos_tbl_customers`
--

INSERT INTO `pos_tbl_customers` (`cus_id`, `branchcode`, `cus_name`, `cus_type`, `inactive`, `cus_gender`, `cus_phone`, `cus_email`, `cus_province`, `cus_district`, `cus_commune`, `cus_village`, `cus_address`, `inputer`, `inputdate`) VALUES
('0002', '0001', 'General', NULL, '0', '01', '010500313', NULL, NULL, NULL, NULL, NULL, 'Phnom Penh', 'joincoder@gmail.com', '2021-08-16 11:06:42'),
('0098', '0168', 'General', NULL, '0', '01', '010500313', NULL, NULL, NULL, NULL, NULL, 'Phnom Penh', 'pos@gmail.com', '2021-08-16 11:17:33');
...
INSERT INTO `pos_tbl_document_file` (`sysdonum`, `trancode`, `branchcode`, `file_path`, `file_name`, `org_name`, `file_ext`, `status`, `inputer`, `inputdate`) VALUES
...
('0009', '0168', '0118', '01', '2.00', 'Fee of delivery  invoice : 0118', '2021-08-16 14:11:05');
...
--
-- Dumping data for table `pos_tbl_invoices`
--

INSERT INTO `pos_tbl_invoices` (`inv_num`, `cus_id`, `branchcode`, `inv_date`, `inv_reason`, `inv_exchange`, `inv_referent`, `sys_token`, `inputer`, `inputdate`, `authorizer`, `auth_date`) VALUES
('0118', '0098', '0168', '2021-08-16 14:11:05', NULL, '4100.00', NULL, '0168-611a0f89088ba', 'pos@gmail.com', '2021-08-16 14:11:05', 'pos@gmail.com', '2021-08-16 14:12:03');
...
INSERT INTO `pos_tbl_line` (`line_id`, `line_name`, `line_type`, `inactive`, `inputer`) VALUES
('01', 'Gender', NULL, 0, 'IT.SYSTEM'),
...
--
-- Dumping data for table `pos_tbl_payment_method`
--

INSERT INTO `pos_tbl_payment_method` (`pay_id`, `branchcode`, `pay_name`, `pay_account`, `inputer`, `inputdate`) VALUES
('0001', '0168', 'Bank Acc :', '010500313 (JoinCoder)', 'IT.SYTEM', '2021-04-13 15:18:32');
...
INSERT INTO `pos_tbl_products` (`pro_id`, `branchcode`, `barcode`, `pro_type`, `pro_line`, `pro_name`, `pro_cost`, `pro_up`, `pro_discount`, `pro_inactive`, `remark`, `inputer`, `inputdate`) VALUES
('0001-0001', '0001', 'T0001', '0001-0007', '0001-0005', 'logitech G102', '16.00', '20.00', '0.00', 0, NULL, 'joincoder@gmail.com', '2021-03-27 16:29:24'),
('0001-0002', '0001', 'T0002', '0001-0008', '0001-0005', 'Monitor MSI 27inc', '150.00', '170.00', '0.00', 0, NULL, 'joincoder@gmail.com', '2021-03-27 16:30:16'),
...
('0027-0005', '0027', 'A0001', '0027-0013', '0027-0006', 'Key board G201', '3.00', '4.50', '0.00', 0, NULL, 'joincoder@gmail.com', '2021-03-04 22:04:07'),
('0027-0006', '0027', '00001', '0027-0013', '0027-0004', 'Iphone 8', '350.00', '450.00', '0.00', 0, NULL, 'joincoder@gmail.com', '2021-03-04 22:24:24'),
('0027-0016', '0027', '00001111', '0027-0013', '0027-0004', 'Monitor Dell 24inc', '355.00', '370.00', '0.00', 0, 's', 'joincoder@gmail.com', '2021-03-20 16:45:16'),
('0027-0017', '0027', '00666', '0027-0013', '0027-0004', 'Iphone 8 plus', '300.00', '4900.00', '5.00', 0, NULL, 'joincoder@gmail.com', '2021-03-21 18:31:46'),
('0027-0018', '0027', 'msi0001', '0027-0022', '0027-0006', 'Monitor MSI 27inc', '450.00', '470.00', '0.00', 0, NULL, 'joincoder@gmail.com', '2021-03-25 13:43:36'),
('0027-0019', '0027', 'msi0002', '0027-0013', '0027-0006', 'logitech G102', '20.00', '22.00', '5.00', 0, NULL, 'joincoder@gmail.com', '2021-03-25 13:46:22'),
...
('0168-0035', '0168', '0038', '0168-0013', '0168-0005', 'Type-C 10 in 1', '19.00', '39.00', '0.00', 0, NULL, 'bongratha@gmail.com', '2021-05-13 06:39:32'),
...
INSERT INTO `pos_tbl_proline` (`line_id`, `branchcode`, `line_name`, `line_type`, `inactive`, `line_remark`, `inputer`, `inputdate`, `store_id`) VALUES
('0001-0001', '0001', 'Main stock', '02', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:26:08', NULL),
('0001-0002', '0001', 'Sale stock', '02', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:26:29', NULL),
('0001-0003', '0001', 'Male', '01', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:26:53', NULL),
('0001-0004', '0001', 'Female', '01', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:27:02', NULL),
('0001-0005', '0001', 'Harward', '03', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:27:17', NULL),
('0001-0006', '0001', 'Software', '03', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:27:31', NULL),
('0001-0007', '0001', 'Mouse', '04', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:27:45', NULL),
('0001-0008', '0001', 'Keyboard', '04', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:27:55', NULL),
('0001-0009', '0001', 'VIP', '05', '0', NULL, 'joincoder@gmail.com', '2021-03-27 16:28:12', NULL),
('0001-0010', '0001', 'G-Supplier', '07', '0', NULL, 'joincoder@gmail.com', '2021-03-28 10:18:36', NULL),
('0001-0011', '0001', 'VIP', '07', '0', NULL, 'joincoder@gmail.com', '2021-03-28 10:18:46', NULL),
...
('0027-0001', '0027', 'Male', '01', '0', 'Remark', 'joincoder@gmail.com', '2021-03-20 13:53:56', NULL),
('0027-0003', '0027', 'Female', '01', '0', NULL, 'joincoder@gmail.com', '2021-03-14 19:52:32', NULL),
('0027-0004', '0027', 'Software', '03', '0', NULL, 'joincoder@gmail.com', '2021-03-25 13:42:47', NULL),
('0027-0006', '0027', 'Harward', '03', '0', NULL, 'joincoder@gmail.com', '2021-03-25 13:42:56', NULL),
('0027-0013', '0027', 'Box', '04', '0', NULL, 'joincoder@gmail.com', '2021-03-04 09:52:02', NULL),
('0027-0015', '0027', 'Cost', '05', '0', NULL, 'joincoder@gmail.com', '2021-02-27 15:24:42', NULL),
('0027-0016', '0027', 'VIP', '07', '0', NULL, 'joincoder@gmail.com', '2021-02-27 15:24:26', NULL),
('0027-0017', '0027', 'G-Supplier', '07', '0', NULL, 'joincoder@gmail.com', '2021-02-28 10:03:48', NULL),
('0027-0018', '0027', 'Water', '04', '1', NULL, 'joincoder@gmail.com', '2021-03-25 14:00:46', NULL),
('0027-0019', '0027', 'Stock expired', '02', '0', NULL, 'joincoder@gmail.com', '2021-03-20 11:46:35', NULL),
('0027-0020', '0027', 'Stock Sale', '02', '0', NULL, 'joincoder@gmail.com', '2021-03-23 22:26:35', NULL),
('0027-0021', '0027', 'Stock main', '02', '0', NULL, 'joincoder@gmail.com', '2021-03-20 11:45:58', NULL),
('0027-0022', '0027', 'Monitor', '04', '0', NULL, 'joincoder@gmail.com', '2021-03-25 13:42:34', NULL),
...
('0168-0031', '0168', 'N/A', '03', '0', NULL, 'TECHNOZOON@gmail.com', '2021-05-09 14:53:56', NULL),
...
('0022', '0012', '0168', '0168-0019', 'B0012', '0168-0004', '20.00', NULL, '10.00', '5.00', '190.00', '01', '', NULL, NULL),
('0023', '0012', '0168', '0168-0029', '0033', '0168-0004', '25.00', NULL, '20.00', '5.00', '475.00', '01', '', NULL, NULL),
...
INSERT INTO `pos_tbl_purchase_order` (`pur_id`, `branchcode`, `sup_id`, `pur_invoice`, `remark`, `inputer`, `inputdate`, `sys_token`) VALUES
('0001', '0001', '0001-0001', 'NO00022', '', 'joincoder@gmail.com', '2021-03-28 10:19:43', '0001-605ff5cfc0d6d'),
...
('0002', '0001', '0001-0001', 'NA00001', '', 'joincoder@gmail.com', '2021-03-28 10:30:35', '0001-605ff85b40e92'),
...
('0012', '0168', '0168-0001', '01020303', 'from good supply ', 'pos@gmail.com', '2021-08-16 14:15:18', '0168-611a10861fd7e'),
('0027-0043', '0027', '0027-0004', 'NA00001', 'top remark', 'joincoder@gmail.com', '2021-03-18 15:04:23', '0027-60530987d6a58'),
('0027-0055', '0027', '0027-0004', 'NO00022', 's', 'joincoder@gmail.com', '2021-03-19 11:12:04', '0027-6054249409c7f'),
('0027-0062', '0027', '0027-0015', 'NA00001', 'top remark', 'joincoder@gmail.com', '2021-03-19 13:19:16', '0027-60544264d7873'),
('0063', '0027', '0027-0004', 'wwww', 'Remark sale', 'joincoder@gmail.com', '2021-03-19 13:21:49', '0027-605442fd69068'),
('0064', '0027', '0027-0004', 'NO00022', 'sell home', 'joincoder@gmail.com', '2021-03-19 14:55:25', '0027-605458edc555c'),
('0065', '0027', '0027-0015', 'NO000123', 'top remark', 'joincoder@gmail.com', '2021-03-19 14:56:08', '0027-6054591850776'),
('0074', '0027', '0027-0015', 'In0001', 'Remark sale', 'joincoder@gmail.com', '2021-03-19 20:22:02', '0027-6054a57a551a1'),
('0075', '0027', '0027-0004', 'NO00022', 'top remark', 'joincoder@gmail.com', '2021-03-19 20:27:45', '0027-6054a6d1c8ea5'),
('0076', '0027', '0027-0004', 'NA00001', 'top remark', 'joincoder@gmail.com', '2021-03-20 10:11:00', '0027-605567c421240'),
('0077', '0027', '0027-0004', 'NO00022', 'top remark', 'joincoder@gmail.com', '2021-03-20 11:08:38', '0027-605575463b275'),
('0078', '0027', '0027-0004', 'NO00022', 'Remark sale', 'joincoder@gmail.com', '2021-03-20 11:19:57', '0027-605577eda5f34'),
('0079', '0027', '0027-0004', 'NO00022', 'for sale', 'joincoder@gmail.com', '2021-03-20 11:21:46', '0027-6055785a6e106'),
('0080', '0027', '0027-0004', 'In0001', 'Remark sale', 'joincoder@gmail.com', '2021-03-20 11:42:22', '0027-60557d2ee170f'),
('0081', '0027', '0027-0015', 'NA000010', '', 'joincoder@gmail.com', '2021-03-20 11:49:34', '0027-60557ede03054'),
('0082', '0027', '0027-0004', 'In0001', '', 'joincoder@gmail.com', '2021-03-20 11:50:06', '0027-60557efe05a82'),
('0083', '0027', '0027-0004', 'NO00022', 'top remark', 'joincoder@gmail.com', '2021-03-20 11:51:34', '0027-60557f56543df'),
('0084', '0027', '0027-0004', 'NO00022', '', 'joincoder@gmail.com', '2021-03-20 11:52:46', '0027-60557f9e28fd0'),
('0085', '0027', '0027-0004', 'NO00022', 'remark', 'joincoder@gmail.com', '2021-03-20 11:53:28', '0027-60557fc8acdfc'),
('0086', '0027', '0027-0004', 'NO00022', 'Remark sale', 'joincoder@gmail.com', '2021-03-20 15:55:01', '0027-6055b865c4769'),
('0087', '0027', '0027-0015', 'NA000010', 'Remark sale', 'joincoder@gmail.com', '2021-03-21 14:27:43', '0027-6056f56f4a64c'),
('0088', '0027', '0027-0015', 'NA000010', 'top remark', 'joincoder@gmail.com', '2021-03-23 13:41:30', '0027-60598d9ade45c'),
('0089', '0027', '0027-0015', 'NO00022', '', 'joincoder@gmail.com', '2021-03-23 14:42:03', '0027-60599bcb034b2'),
('0090', '0027', '0027-0015', 'NA000010', 'Remark sale', 'joincoder@gmail.com', '2021-03-23 21:13:10', '0027-6059f77633ff3'),
('0091', '0027', '0027-0016', 'NO00022', '', 'joincoder@gmail.com', '2021-03-25 13:49:26', '0027-605c3276dbd6e');
...
--
-- Dumping data for table `pos_tbl_stockouts`
--

INSERT INTO `pos_tbl_stockouts` (`sto_num`, `branchcode`, `inv_num`, `pro_code`, `pro_barcode`, `stock_code`, `pro_cost`, `pro_qty`, `pro_up`, `pro_discount`, `pro_amount`, `pro_qty_amount`, `trandate`) VALUES
('0001', '0001', '0007', '0001-0001', 'T0001', '0001-0001', '16.00', '2.00', '20.00', '10.00', '36.00', NULL, NULL),
('0001', '0004', '0005', '0004-0001', 'A0001', '0004-0004', '15.00', '1.00', '21.50', '10.00', '19.35', NULL, NULL),
('0002', '0001', '0008', '0001-0001', 'T0001', '0001-0001', '16.00', '2.00', '20.00', '0.00', '40.00', NULL, NULL),
('0002', '0004', '0006', '0004-0002', 'A0002', '0004-0003', '155.00', '1.00', '165.00', '0.00', '165.00', NULL, NULL),
('0003', '0001', '0009', '0001-0001', 'T0001', '0001-0002', '16.00', '3.00', '20.00', '10.00', '54.00', NULL, NULL),
('0003', '0168', '0003', '0168-0010', 'B0003', '0168-0004', '20.00', '1.00', '20.00', '0.00', '20.00', NULL, NULL),
('0004', '0001', '0009', '0001-0001', 'T0001', '0001-0001', '16.00', '5.00', '20.00', '10.00', '90.00', NULL, NULL),
('0004', '0004', '0008', '0004-0001', 'A0001', '0004-0003', '15.00', '1.00', '21.50', '0.00', '21.50', NULL, NULL),
('0004', '0168', '0004', '0168-0001', 'A0001', '0168-0004', '15.00', '1.00', '20.00', '0.00', '20.00', NULL, NULL),
('0005', '0001', '0010', '0001-0002', 'T0002', '0001-0001', '150.00', '9.00', '170.00', '0.00', '1530.00', NULL, NULL),
('0005', '0168', '0005', '0168-0001', 'A0001', '0168-0004', '15.00', '1.00', '20.00', '0.00', '20.00', NULL, NULL),
('0006', '0027', '0009', '0027-0017', '00666', '0027-0019', '300.00', '2.00', '4900.00', '5.00', '9310.00', NULL, NULL),
('0051', '0027', '0027-0020', '0027-0019', 'Remark sale', 'joincoder@gmail.com', '2021-03-26 13:24:28', 'joincoder@gmail.com', '2021-03-26 13:24:34', '0027-605d7e1c8881d');
...
INSERT INTO `pos_tbl_supplier` (`sup_id`, `branchcode`, `sup_name`, `sup_type`, `sup_phone`, `sup_email`, `sup_address`, `sup_website`, `inactive`, `sub_fax`, `inputer`, `inputdate`) VALUES
('0001-0001', '0001', 'General', '0001-0010', '078500333', 'abc@gmail.com', 'phnom penh thmey', 'www.toanchet.com', '0', NULL, 'joincoder@gmail.com', '2021-03-28 10:19:21'),
...
('0027-0004', '0027', 'VSP', '0027-0016', '078500313', 'home@gmail.com', 'Kompot', 'www.toanchet.com', '0', NULL, 'joincoder@gmail.com', '2021-02-28 14:04:35'),
('0027-0015', '0027', 'Bong Map', '0027-0016', '010500666', 'progamil.com', 'ddd', 'www.icream.com', '0', NULL, 'joincoder@gmail.com', '2021-03-15 09:16:10'),
('0027-0016', '0027', 'CHANTRA computer shop', '0027-0016', '099998877,010500313', NULL, 'Phnom penh', 'www.chantracomputer', '0', NULL, 'joincoder@gmail.com', '2021-03-25 13:39:03'),
...
INSERT INTO `pos_tbl_transactions` (`sysdocnum`, `branchcode`, `pro_code`, `pro_barcode`, `trancode`, `stockcode`, `trn_status`, `trn_ref`, `trn_qty`, `trn_qty_tt`, `inputer`, `inputdate`) VALUES
...
('0058', '0001', '0001-0001', 'T0001', '01', '0001-0001', 'purchaseorder', '0001', '10.0000', '10.0000', 'joincoder@gmail.com', '2021-03-28 10:19:48'),
('0058', '0168', '0168-0019', 'B0012', '02', '0168-0004', 'auth_pos_invoice', '0010', '-1.0000', '4.0000', 'bongratha@gmail.com', '2021-04-13 06:40:36'),
('0059', '0001', '0001-0001', 'T0001', '02', '0001-0001', 'auth_pos_invoice', '0008', '-2.0000', '8.0000', 'joincoder@gmail.com', '2021-03-28 10:20:24'),
('0059', '0168', '0168-0020', 'b00012', '02', '0168-0004', 'auth_pos_invoice', '0011', '-1.0000', '-1.0000', 'bongratha@gmail.com', '2021-04-13 06:40:48'),
('0060', '0001', '0001-0001', 'T0001', '04', '0001-0001', 'f_stocktransfer', '0003', '-3.0000', '5.0000', 'joincoder@gmail.com', '2021-03-28 10:28:59'),
('0060', '0168', '0168-0021', 'B0013', '02', '0168-0004', 'auth_pos_invoice', '0012', '-1.0000', '-1.0000', 'bongratha@gmail.com', '2021-04-13 06:42:57'),
('0061', '0001', '0001-0001', 'T0001', '03', '0001-0002', 't_stocktransfer', '0003', '5.0000', '5.0000', 'joincoder@gmail.com', '2021-03-28 10:28:59'),
('0061', '0168', '0168-0021', 'B0013', '01', '0168-0004', 'purchaseorder', '0003', '9.0000', '8.0000', 'bongratha@gmail.com', '2021-04-13 08:30:41'),
('0062', '0001', '0001-0002', 'T0002', '01', '0001-0001', 'purchaseorder', '0002', '100.0000', '100.0000', 'joincoder@gmail.com', '2021-03-28 10:30:39'),
...
INSERT INTO `pos_tbl_una_document_file` (`sysdonum`, `trancode`, `branchcode`, `file_path`, `file_name`, `org_name`, `file_ext`, `status`, `inputer`, `inputdate`) VALUES
...
INSERT INTO `pos_tbl_una_invoices` (`inv_num`, `cus_id`, `branchcode`, `inv_date`, `inv_reason`, `inv_exchange`, `inv_referent`, `sys_token`, `inputer`, `inputdate`, `authorizer`, `auth_date`) VALUES
('0014', '0008', '0027', '2021-03-24 14:00:35', NULL, '4100.00', NULL, '0027-605ae39370f56', 'joincoder@gmail.com', '2021-03-24 14:00:35', NULL, NULL),
('0101', '0082', '0168', '2021-07-17 06:12:48', NULL, '4100.00', NULL, '0168-60f274e042af5', 'Sale@gmail.com', '2021-07-17 06:12:48', NULL, NULL),
('0116', '0097', '0168', '2021-08-14 06:09:01', NULL, '4100.00', NULL, '0168-61175dfd59822', 'Sale@gmail.com', '2021-08-14 06:09:01', NULL, NULL),
('0117', '0098', '0168', '2021-08-16 11:26:06', NULL, '4100.00', NULL, '0168-6119e8dea715d', 'pos@gmail.com', '2021-08-16 11:26:06', NULL, NULL);
...
INSERT INTO `pos_tbl_una_invoice_return` (`inv_num`, `cus_id`, `branchcode`, `inv_date`, `inv_reason`, `inv_exchange`, `inv_referent`, `sys_token`, `inputer`, `inputdate`, `authorizer`, `auth_date`) VALUES
...
('0122', '0168', '0116', '0168-0024', 'B0016', '0168-0004', '8.50', '2.00', '15.00', '0.00', '30.00', NULL, NULL),
('0123', '0168', '0117', '0168-0029', '0033', '0168-0003', '27.00', '1.00', '49.00', '50.00', '24.50', NULL, NULL),
('0124', '0168', '0117', '0168-0011', 'B0004', '0168-0003', '12.50', '1.00', '22.00', '20.00', '17.60', NULL, NULL);
...
INSERT INTO `pos_tbl_una_stocktransfer` (`tran_code`, `branchcode`, `f_stock`, `t_stock`, `remark`, `inputer`, `inputdate`, `authorizer`, `auth_date`, `sys_token`) VALUES
...
('0004', 'LAND', '2019-01-01 00:00:00', '0', 'joincoder@gmail.com', 'fa fa-eye', 'fa fa-angle-left pull-right', NULL, 'nav-icon fas fa-table', 'pull-right-container', 'right fas fa-angle-left', 3),
...
INSERT INTO `tbl_menu_permission` (`per_id`, `menu_id`, `systemid`, `views`, `booking`, `edit`, `deletes`, `menu_order`, `keytoken`, `inputer`, `inputdate`) VALUES
('0293', '0001', '30', 0, 0, 0, 0, NULL, '610aaf4ee090a', 'joincoder@gmail.com', '2021-08-04 15:16:30'),
('0294', 'SUB0014', '30', 0, 0, 0, 0, NULL, '610aaf4ee090a', 'joincoder@gmail.com', '2021-08-04 15:16:30'),
('0295', 'SUB0021', '30', 0, 0, 0, 0, NULL, '610aaf4ee090a', 'joincoder@gmail.com', '2021-08-04 15:16:30'),
('0296', 'SUB0022', '30', 0, 0, 0, 0, NULL, '610aaf4ee090a', 'joincoder@gmail.com', '2021-08-04 15:16:30'),
('0297', 'SUB0025', '30', 0, 0, 0, 0, NULL, '610aaf4ee090a', 'joincoder@gmail.com', '2021-08-04 15:16:30'),
('0457', '0014', '20', 0, 0, 0, 0, NULL, '6119dfb3bdbea', 'joincoder@gmail.com', '2021-08-16 10:46:59'),
('0458', 'SUB0041', '20', 0, 0, 0, 0, NULL, '6119dfb3bdbea', 'joincoder@gmail.com', '2021-08-16 10:46:59'),
('0469', 'SUB0020', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0470', 'SUB0023', '20', 0, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0471', 'SUB0029', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0472', 'SUB0040', '20', 0, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0473', '0004', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0474', 'SUB0016', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0475', 'SUB0018', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0476', 'SUB0019', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0477', '0005', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25'),
('0478', 'SUB0005', '20', 1, 0, 0, 0, NULL, '6119e1351472f', 'joincoder@gmail.com', '2021-08-16 10:53:25');
...
INSERT INTO `tbl_menu_permission_branch` (`per_id`, `menu_id`, `profile_id`, `branchcode`, `views`, `booking`, `edit`, `deletes`, `keytoken`, `inputer`, `inputdate`) VALUES
...
('SUB0016', '0004', 'Customer info', 'admin', 'customer_land', '0', 'joincoder@gmail.com', 'fa fa-google-plus', '2020-08-15 21:30:22', 2),
('SUB0017', '0003', 'Land line', 'Land', 'land_line', '0', 'joincoder@gmail.com', 'fa fa-folder-open', '2020-08-15 21:30:22', 0),
('SUB0018', '0004', 'Item Land', 'Land', 'registerland', '0', 'joincoder@gmail.com', 'fa fa-folder-open', '2020-08-15 21:30:22', 1),
('SUB0019', '0004', 'Sell Land', 'admin', 'sale_land', '0', 'joincoder@gmail.com', 'fa fa-hand-o-right', '2020-08-15 21:30:22', 4),
('SUB0011', '0002', 'Reg Customer', 'pos', 'add_customer', '0', 'IT.SYSTEM', '\'NULL\'', '2021-03-20 13:02:45', 2),
('SUB0020', '0003', 'Setup branch', 'Setting', 'setupbranch', '0', 'joincoder@gmail.com', 'fa fa-hand-o-right', '2020-08-15 21:30:22', 0),
...
('SUB0039', '0006', 'Add Item', 'loandd', 'create_loandd', '0', 'IT.SYSTEM', '\'NULL\'', '2021-07-18 21:13:38', NULL),
...
--
-- Indexes for table `loan_tbl_clients`
--
ALTER TABLE `loan_tbl_clients`
  ADD PRIMARY KEY (`groupid`);

--
-- Indexes for table `loan_tbl_groups`
--
ALTER TABLE `loan_tbl_groups`
