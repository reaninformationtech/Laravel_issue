        ...
        <form method="post" id="form_data" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">
                        <a href="{{url('/pos_pos')}}" class="text-center">
                            ...
                            <tr class="table-secondary">
                                ...
                                <td>
                                    ...
                                    <div class="row mb-12">
                                        <div class="col-sm-6">
                                            <div class="row mb-2">
                                                <a href="{{url('pos_invoice_view/'.$row->inv_num)}}" class="text-center">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row mb-2">
                                                <a href="{{url('pos_invoices_pdf/'.$row->inv_num)}}"  target="_blank" class="text-center">
