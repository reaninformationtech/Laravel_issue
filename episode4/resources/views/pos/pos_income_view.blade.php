                        ...
                        @if (isset($file[0]->sysdonum))
                            <div class="timeline-item">
                                <div class="timeline-body">
                                    @foreach ($file as $row)
                                        <img src="{{ route('pos.pos_income_file',$row->file_name) }}" class="img-thumbnail" alt="None"
            ...
            $('#authorize_record').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = "/pos_income_list/all";
                    }
                })
