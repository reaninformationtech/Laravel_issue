        ...
        <div class="col-md-12">
            <form method="post" id="form_data" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                            ...
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">Stock from</label>
                                                <div class="col-sm-5">
                                                    <select class="selectpicker form-control" name="stockfrom"
                                                        id="stockfrom" data-live-search="true">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">Stock to</label>
                                                <div class="col-sm-5">
                                                    <select class="selectpicker form-control" name="stockto" id="stockto"
                    ...
                    <div id="table_data">
                        @include('pos_report/rpt_pos_stock_transfer_data')
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form_data').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('pos_report.rpt_get_pos_stock_transfer') }}",
                    method: "POST",
                    async: false,
